...
{
    static Exports() => Load<WuwaPlugin>(!RuntimeFeature.IsDynamicCodeCompiled ? new Core.Management.GameVersion(0, 2, 0, 0) : default); // Loads the IPlugin instance as WuwaPlugin.
